...
import F17 from "../../components/img/17-17-17.png";
import F14 from "../../components/img/14-35-14.png";
import F10 from "../../components/img/10-26-26.png";
import F20 from "../../components/img/20-20.png";
import F28 from "../../components/img/28-28.png";
import DAP from "../../components/img/DAP.png";
      ...
      fetch(url, {
        ...
        .then((data) => {
          ...
          if (main_data && main_data["prediction"]) {
            ...
            // Handle the case where 'prediction' is not present in the response
            console.error("Prediction data is missing in the response.");
          }
